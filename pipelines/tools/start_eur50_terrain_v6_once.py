...
OUT=ROOT/'evidence/code-layout-flat-live-v6';OUT.mkdir(parents=True,exist_ok=True)
...
with httpx.Client(base_url='http://127.0.0.1:48765',timeout=180) as c:
 ...
 resp=c.post('/api/hybrid-runs',json=body,headers={'Idempotency-Key':'eur50-flat-terrain-recovery-v6-20260923'})
