...
const require=createRequire(import.meta.url),out='evidence/hybrid-sampling-repair',RID='bf0775b583fc44d689907e042b29f96c',PARENT='1be76cabfa584293be43c418653d9a40';
...
try{const page=await browser.newPage({viewport:{width:900,height:640},deviceScaleFactor:1});
 ...
 const scenes=[['before','file://'+process.cwd()+'/data/hybrid/'+PARENT+'/candidate-0/scene.png'],
   ['after','file://'+process.cwd()+'/data/hybrid/'+RID+'/candidate-1/scene.png'],
   ['sample-after','file://'+process.cwd()+'/data/hybrid/'+RID+'/sample-0-1/scene.png']];
